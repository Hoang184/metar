...
df = pd.read_csv(r'D:\Documents\Python Code\K-means\data_approach_new.csv')
...
print(kl.elbow)
kmeans = KMeans(n_clusters=5).fit(df[['long','lat']])
...
filepath = Path('D:\Documents\Python Code\K-means\k_mean_final.csv')
